        ...
        >
          ...
          <Link href="/" className="flex items-center gap-2 group flex-shrink-0">
              <div className="flex flex-col">
                  <span className="text-xl font-black text-white tracking-tighter font-heading leading-none">ELENTRO<span className="text-primary italic">.</span></span>
        ...
        {isOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-16">
              <span className="text-2xl font-black text-white">ELENTRO<span className="text-primary">.</span></span>
              <button 
