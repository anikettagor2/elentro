      ...
      <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-6">
            <Link href="/" className="block group">
                <div className="flex flex-col">
                    <span className="text-2xl font-black text-white tracking-tighter font-heading">ELENTRO<span className="text-primary italic">.</span></span>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between text-xs font-mono">
          <div className="flex flex-col gap-1">
            <p>© 2026 ELENTRO SIM ENGINE. ALL RIGHTS RESERVED.</p>
