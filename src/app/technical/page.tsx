      ...
      <main className="container mx-auto px-4 pt-32 pb-24">
        <div className="max-w-4xl mx-auto text-center mb-20">
          ...
          <p className="text-zinc-400 text-lg max-w-2xl mx-auto leading-relaxed">
            Elentro is engineered for mission-critical reliability, leveraging state-of-the-art AI orchestration and cloud-native security patterns.
          </p>
        </div>
        ...
        >
          <div className="absolute top-0 right-0 p-8 opacity-20">
            <LineChart className="w-48 h-48 text-indigo-500" />
          </div>
          
          <div className="relative z-10 max-w-2xl">
            <h2 className="text-3xl font-bold mb-6 tracking-tight">AI Strategy Protocol v2.0</h2>
            <div className="space-y-6 text-zinc-400">
              <p>
                Elentro's proprietary <strong>Resilience Engine</strong> manages Vertex AI orchestration with advanced load-balancing. 
                Utilizing Gemini 1.5 Pro's massive context window, the system analyzes complex electoral demographics in sub-millisecond cycles.
              </p>
              <p>
                Our <strong>Neural Tabulation</strong> logic ensures that AI-generated insights are synchronized with real-time voting data, 
                providing a unified intelligence layer for strategic decision-making.
              </p>
            </div>
          </div>
        </motion.div>
